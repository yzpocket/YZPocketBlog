...
const ServiceCard: React.FC = () => {
  ...
  return (
    <>
      <div className="p-1 mb-3 dark:text-white">🌟 Productions</div>
      <ul className="rounded-2xl mb-9 bg-white dark:bg-zinc-700 p-1 flex flex-col">
        ...
        >
          ...
          <a
              href={`${CONFIG.projects[3].href}`}
              rel="noreferrer"
              target="_blank"
              className="p-3 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-2xl cursor-pointer flex items-center gap-3 text-gray-500 dark:text-white hover:text-black dark:hover:text-white"
          >
              <AiFillCodeSandboxCircle className="text-2xl" />
              <div className="text-sm">{CONFIG.projects[3].name}</div>
          </a>
          <a
              href={`${CONFIG.projects[4].href}`}
              rel="noreferrer"
              target="_blank"
              className="p-3 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-2xl cursor-pointer flex items-center gap-3 text-gray-500 dark:text-white hover:text-black dark:hover:text-white"
          >
              <AiFillCodeSandboxCircle className="text-2xl" />
              <div className="text-sm">{CONFIG.projects[4].name}</div>
          </a>
      </ul>
    </>
  )
